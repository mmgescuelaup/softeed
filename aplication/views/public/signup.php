...
<body>
    ...
    <div>
        <a href="<?php echo $helper->url("registre","reclutador"); ?>"><button class="button">Reclutador</button></a>
        <br>
        <a href="<?php echo $helper->url("registre","estudiante"); ?>"><button class="button">Estudiante</button></a>
    </div>
    </div>
    </div>
